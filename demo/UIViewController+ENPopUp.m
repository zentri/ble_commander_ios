...
//
//  https://github.com/evnaz/ENPopUp
//
...
static CGFloat const kRotationAngle = 0.0f;
...
- (void)dismissPopUpViewControllerWithcompletion:(void (^)(void))completionBlock
{
    ...
    JWBlurView *blurView = (JWBlurView *)[sourceView.superview viewWithTag:kENPopUpBluredViewTag];
    UIView *popupView = [sourceView viewWithTag:kENPopUpViewTag];
    UIView *overlayView = [sourceView.superview viewWithTag:kENPopUpOverlayViewTag];
								 ...
								 completion:(void (^)(void))completionBlock
{
    ...
    [UIView animateWithDuration:kAnimationDuration
                     animations:^ {
                         ...
                         [overlayView setAlpha:0.f];
                         [popupView setAlpha:0.f];
                         //popupView.layer.transform = transform;
                     }
                     completion:^(BOOL finished) {
